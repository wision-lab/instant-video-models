...
from stability.datasets.nfs import NFSVideo
from stability.datasets.utils import FrameIterator, aligned_torch_rngs
...
class NFSLaplacian(NFSVideo):
    ...
    def __len__(self) -> int:
        ...
        """
        return len(self.video_ids) * len(self.frame_drop_ratios)
