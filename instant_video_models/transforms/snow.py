"""Defines the simulated snow transform."""
...
class Snow(FrameTransform):
    ...
    def __init__(
        ...
        Args:
            min_density: The minimum number of snowflakes per pixel. Defaults to 5e-5.
            max_density: The maximum number of snowflakes per pixel;. Defaults to 1e-4.
            min_size: The minimum size (ellipse long or short axis) of snowflakes.
                Defaults to 5.0.
            max_size: The maximum size (ellipse long or short axis) of snowflakes.
                Defaults to 10.0.
            min_rotation: The minimum rotation of snowflake ellipses in degrees.
                Defaults to 0.0.
            max_rotation: The maximum rotation of snowflake ellipses in degrees.
                Defaults to 180.0.
            min_transparency: The minimum transparency of snowflakes. Defaults to 0.5.
            max_transparency: The maximum transparency of snowflakes. Defaults to 1.0.
            min_blur: The minimum Gaussian blur to apply to snowflakes. Defaults to 1.0.
            max_blur: The maximum Gaussian blur to apply to snowflakes. Defaults to 4.0.
        """
        super().__init__()
